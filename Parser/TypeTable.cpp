...
This method is required since we need to have a complete AST ready
to figure out namespace but we start creating the type table even 
simultaneously while parsing. Hence this is required */
