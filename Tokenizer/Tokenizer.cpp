...
//----< class that solves for next state when c/c++ style comment conditions appear >-----------------------
...
//----< class that solves for next state when single/double quoted string conditions appear >-----------------------
...
void testToker(Toker &toker, std::ifstream &in)
{
