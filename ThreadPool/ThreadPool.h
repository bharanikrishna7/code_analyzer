...
* void setThreads();											// Sets the # of threadpools to maximum threads supported by the hardware executing this program
* void setThreads(int threadCount);								// Sets the # of threadpools to threadCount (not recommended to use it)
* void init();													// This methods will set threadspools to max threads supported by hardware and call start();
*
* Required files:
* ---------------
...
/////////////////////////////////////////////////////////////////////
/* class to process work items - Execute work items Asynchronously */
template<typename Result>
class ThreadPool
{
public:
...
/* set the thread count for parallel processing */
template <typename Result>
void ThreadPool<Result>::setThreads(int threadCount) {
	_cpuThreads = threadCount;
}
