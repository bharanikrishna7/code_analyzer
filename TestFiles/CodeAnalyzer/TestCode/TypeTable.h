...
* - first release
* ver 1.1 : 31 May 2016
* - moved the code associated with typetable to Parser project
*
* Credits:
* --------
...
/* 
 * The Entry will be used to hold each of the record which we 
 * choose to store in the partial type table. In our case we are 
 * using the type table to hold the name(s) of each scope, namespace
 * and aliases we encounter in the code.
*/
struct Entry
{
	std::string _name;
