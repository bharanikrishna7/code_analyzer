// Not editing the Prologue of this module since the original author
// (Prof. Jim Fawcett) asked not to change the notice to use this module.
// Also nothing has been changed or modified.
